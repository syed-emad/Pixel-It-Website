...
//            $result .= static::$LE;
     ...
     * $basedir is prepended when handling relative URLs, e.g. <img src="/images/a.jpg"> and must not be empty
     * will look for an image file in $basedir/images/a.jpg and convert it to inline.
